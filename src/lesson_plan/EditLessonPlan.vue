            ...
            <div class="myRow" style="height: 100%; width: 100%">
                <div class="right">
                    ...
                    <div v-if="id == -1" style="height: 100%; width: 100%">
                        ...
                        <div class="myRow list" style="margin-left: 20px">
                            ...
                            <div class="w10"></div>
                            <el-select style="width: 200px" placeholder="选择学期" :disabled="isItemLocked"
                                v-model="selectTerm" @change="selectingTerm">
                        ...
                        <div class="myRow list" style="margin-left: 20px">
                            ...
                            <div class="w10"></div>
                            <el-select style="width: 200px" placeholder="选择课程" v-model="selectCourse"
                                @change="selectingCourse" :disabled="isItemLocked">
                                <el-option v-for="(t, index) in course" :key="index" :label="t.name"
                        ...
                        <div class="myRow list" style="margin-left: 20px">
                            ...
                            <div class="w10"></div>
                            <el-tree-select style="width: 200px" :placeholder="dynamicPlaceholder" :data="para"
                                v-model="selectParaIndex" :disabled="isItemLocked" :render-after-expand="false"
              ...
              ">
                        ...
                        <div class="myRow">
                            ...
                            <div class="fill"></div>
                            <Icon class="onHover" icon="mdi:attachment" width="24" height="24"
                ...
                ">
                    ...
                    <div v-else class="myCol" style="height: 100%; width: 100%">
                        <el-header style="margin: 0; padding: 0; width: 100%; height: auto">
                            ...
                            <el-divider style="margin-top: 10px; margin-bottom: 0"></el-divider>
                        </el-header>

                        <el-main class="myCol" style="width: 100%; margin: 0; padding: 0">
                            <el-scrollbar style="width: 100%">
                                <div v-for="(t, index) in allCallWord" :key="index" style="
                    height: auto;
                    width: 100%;
                    margin-top: 5px;
                    margin-bottom: 5px;
                  " class="myRow">
                    ...
                    ">
                        ...
                        <el-footer style="width: 100%; height: 120px; margin: 0; padding: 0">
                    ...
                    ">
                      ...
                      ">
                        ...
                        " v-model="callWord"></textarea>
                                ...
                                <div @click="onCreateButton" style="
                    height: 40px;
                    width: 40px;
                    background-color: #19a3fa;
                    border-radius: 50px;
                  ...
                  ">
                                    <div class="myCol" style="height: 100%; width: 100%">
                                        ...
                                        <div class="myRow" style="height: 24; width: 100%">
                                            <div class="fill"></div>
                                            <Icon icon="mdi:send" width="24" height="24" style="color: white" />
                                            <div class="fill"></div>
                                        </div>
                                        <div class="fill"></div>
                                    </div>
