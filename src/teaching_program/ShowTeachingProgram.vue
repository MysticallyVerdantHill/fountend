            ...
            <div class="myRow" style="height: 100%; width: 100%">
              ...
              ">
                  ...
                  " @click="onChangeFull(index)">
                                    ...
                                    <div class="fill"></div>
                                    <Icon icon="mdi:chevron-down" width="25" height="25" style="color: black"
                                        class="rotate180" :class="{ 'rotate-active': isFull[index] }" />
                                </div>
                                <transition name="slide">
                                    <div v-if="isFull[index]">
                                        <div v-for="(sc, iindex) in c.subChapter" :key="iindex">
                                            <div @click="onShowData(index, iindex)" class="content myRow" style="
                          font-size: 20px;
                          height: 40px;
                          width: 100%;
                          border-radius: 10px;
                ...
                <div class="left">
                    <div class="myRow">
                        ...
                        <div class="fill"></div>
                        <el-button v-if="showTitle != ''" @click="onClickNewLessonPlan()">创建教案</el-button>
                        <div class="w20"></div>
                    </div>

                    <el-divider style="margin: 0; margin-bottom: 20px; margin-top: 10px"></el-divider>
                    {{ showData }}
                </div>
            </div>
        </el-main>
...
function onShowData(index: number, iindex: number): void {
    ...
    showTitle.value = `${index + 1}.${iindex + 1}   ${data.value![index].subChapter[iindex].title
        }`;
